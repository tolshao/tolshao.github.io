...
![图｜透视畸变校正前后对比：侧拍照片中的梯形屏幕，被拉正为适合归档和 OCR 的矩形 PPT 页面](../image/ppt-photo-corrector/05-perspective-correction-before-after.png)
...
![图｜屏幕频闪抑制前后对比：左侧横向明暗带与偏色明显，右侧条纹被压低且图表边缘尽量保留](../image/ppt-photo-corrector/06-flicker-correction-before-after.png)
