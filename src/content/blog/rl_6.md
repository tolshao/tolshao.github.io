...
值函数估计：随机梯度下降法SGD
![-w523](/assets/images/15965268722996.jpg)

## Table lookup 是 GD的一种特例
类似于机器学习的分类问题，将状态值写成0、1向量

![-w290](/assets/images/15965277694513.jpg)
## Find a target for value function approximation
把估计函数作为一个监督学习
目标是谁呢，通过MC、TD方法，设定目标
![-w439](/assets/images/15965279560154.jpg)

## 生成训练集

### For linear MC
![-w335](/assets/images/15965286821264.jpg)
- 无偏目标估计
- 局部最优

### For linear TD（0）
![-w479](/assets/images/15965287396993.jpg)
- 收敛趋向全局最优

### For linear TD（$\lambda$）
![-w427](/assets/images/15970471950069.jpg)
...
用q函数，替代v函数
![-w492](/assets/images/15970492924377.jpg)

![-w530](/assets/images/15970496242583.jpg)
...
![-w527](/assets/images/15970511491893.jpg)
引入Gradient TD，完全满足贝尔曼方程，无差
![-w540](/assets/images/15970539060941.jpg)

- 控制学习

![-w503](/assets/images/15970539922026.jpg)
...
LS定义，估计误差平方，求和
![-w495](/assets/images/15970588911111.jpg)
...
![-w526](/assets/images/15970589362830.jpg)
找到使LS最小的权重$w^\pi$
...
![-w610](/assets/images/15970708646292.jpg)
...
6. 用SGD更新
伪算法：
![](/assets/images/15971441168183.jpg)
**注意：**
...
![-w592](/assets/images/15970717288619.jpg)
However，真值**不知道**
缺点是复杂度高，引入了矩阵的逆
### Other algorithms
![-w574](/assets/images/15971205641184.jpg)
![-w598](/assets/images/15971205882497.jpg)
![-w603](/assets/images/15971207382795.jpg)
